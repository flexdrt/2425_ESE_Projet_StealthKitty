...
croutine. h 
\begin{DoxyPre}
 \doxylink{croutine_8h_ac8eb0a81c5cf69de7e4edd73ce44a3be}{crQUEUE\_SEND\_FROM\_ISR(                            QueueHandle\_t pxQueue,                            void *pvBuffer,                            BaseType\_t * pxCoRoutineWoken                       )}\end{DoxyPre}
...
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xResult;
    ...
    \{
        ...
        \doxylink{croutine_8h_a26af3d36f22a04168eebdf5b08465d6e}{crQUEUE\_SEND( xHandle, xCoRoutineQueue, \&cCharToTx, NO\_DELAY, \&xResult )};
     ...
     \{
        cCharToTx = 'a';
     \}
     \doxylink{croutine_8h_a05a06feb11028f2d1d440ea335f562ba}{crDELAY( 100 )};
    \}
