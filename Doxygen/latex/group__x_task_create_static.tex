...
task. h 
\begin{DoxyPre}
\doxylink{task_8h_a25b35e6e19ecf894173e7ff95edb96ef}{TaskHandle\_t} xTaskCreateStatic( TaskFunction\_t pvTaskCode,                              const char * const pcName,                              uint32\_t ulStackDepth,                              void *pvParameters,                              UBaseType\_t uxPriority,                              StackType\_t *pxStackBuffer,                              StaticTask\_t *pxTaskBuffer );\end{DoxyPre}
...
\hline
{\em pc\+Name} & A descriptive name for the task. This is mainly used to facilitate debugging. The maximum length of the string is defined by config\+MAX\+\_\+\+TASK\+\_\+\+NAME\+\_\+\+LEN in \doxylink{_free_r_t_o_s_config_8h}{Free\+RTOSConfig.\+h}.\\
\hline
...
\hline
{\em px\+Stack\+Buffer} & Must point to a \doxylink{portmacro_8h_a84e9a8ba132feed0b2401c1f4e2ac63c}{Stack\+Type\+\_\+t} array that has at least ul\+Stack\+Depth indexes -\/ the array will then be used as the task\textquotesingle{}s stack, removing the need for the stack to be allocated dynamically.\\
\hline
...
\begin{DoxyPre}
   ...
   \doxylink{_free_r_t_o_s_8h_af0002e4ad72220b34b95fcdf43bcd82d}{StaticTask\_t} xTaskBuffer;

   // Buffer that the task being created will use as its stack.  Note this is
   // an array of \doxylink{portmacro_8h_a84e9a8ba132feed0b2401c1f4e2ac63c}{StackType\_t} variables.  The size of \doxylink{portmacro_8h_a84e9a8ba132feed0b2401c1f4e2ac63c}{StackType\_t} is dependent on
   // the RTOS port.
   \doxylink{portmacro_8h_a84e9a8ba132feed0b2401c1f4e2ac63c}{StackType\_t} xStack[ STACK\_SIZE ];
   ...
   \{
       \doxylink{task_8h_a25b35e6e19ecf894173e7ff95edb96ef}{TaskHandle\_t} xHandle = NULL;
