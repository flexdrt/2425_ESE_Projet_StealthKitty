...
queue. h 
\begin{DoxyPre}
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} \doxylink{queue_8h_af03b83396462affe9e28302660e7b9c6}{xQueueSendToFrontFromISR(                                      QueueHandle\_t xQueue,                                      const void *pvItemToQueue,                                      BaseType\_t *pxHigherPriorityTaskWoken                                   )};
\end{DoxyPre}
...
\hline
{\em px\+Higher\+Priority\+Task\+Woken} & \doxylink{queue_8h_af03b83396462affe9e28302660e7b9c6}{x\+Queue\+Send\+To\+Front\+From\+ISR()} will set \texorpdfstring{$\ast$}{*}px\+Higher\+Priority\+Task\+Woken to pd\+TRUE if sending to the queue caused a task to unblock, and the unblocked task has a priority higher than the currently running task. If x\+Queue\+Send\+To\+From\+From\+ISR() sets this value to pd\+TRUE then a context switch should be requested before the interrupt is exited.\\
\hline
\end{DoxyParams}
...
\{
char cIn;
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xHigherPrioritTaskWoken;
   ...
   \{
    ...
    // Post the byte.
    \doxylink{queue_8h_af03b83396462affe9e28302660e7b9c6}{xQueueSendToFrontFromISR( xRxQueue, \&cIn, \&xHigherPriorityTaskWoken )};
...
queue. h 
\begin{DoxyPre}
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} \doxylink{queue_8h_a51e9f73417b11441a181cdc4f33a68e9}{xQueueSendToBackFromISR(                                      QueueHandle\_t xQueue,                                      const void *pvItemToQueue,                                      BaseType\_t *pxHigherPriorityTaskWoken                                   )};
\end{DoxyPre}
...
\{
char cIn;
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xHigherPriorityTaskWoken;
   ...
   \{
    ...
    // Post the byte.
    \doxylink{queue_8h_a51e9f73417b11441a181cdc4f33a68e9}{xQueueSendToBackFromISR( xRxQueue, \&cIn, \&xHigherPriorityTaskWoken )};
...
queue. h 
\begin{DoxyPre}
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} \doxylink{queue_8h_a21d5919ed26c21d121df4a4debeb643c}{xQueueSendFromISR(                                  QueueHandle\_t xQueue,                                  const void *pvItemToQueue,                                  BaseType\_t *pxHigherPriorityTaskWoken                             )};
\end{DoxyPre}
...
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xHigherPriorityTaskWoken;
   ...
   \{
    ...
    // Post the byte.
    \doxylink{queue_8h_a21d5919ed26c21d121df4a4debeb643c}{xQueueSendFromISR( xRxQueue, \&cIn, \&xHigherPriorityTaskWoken )};
...
queue. h 
\begin{DoxyPre}
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} \doxylink{queue_8h_a263711eb0124112e828a18fd4b8ab29d}{xQueueGenericSendFromISR(                                        QueueHandle\_t        xQueue,                                        const    void    *pvItemToQueue,                                        BaseType\_t   *pxHigherPriorityTaskWoken,                                        BaseType\_t   xCopyPosition                                    )};
\end{DoxyPre}
...
\{
char cIn;
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xHigherPriorityTaskWokenByPost;
   ...
   \{
    \doxylink{portmacro_8h_aac6850c66595efdc02a8bbb95fb4648e}{portYIELD\_FROM\_ISR()};
   \}
\}
\end{DoxyPre}
