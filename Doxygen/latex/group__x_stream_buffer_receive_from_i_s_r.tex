...
\begin{DoxyPre}
size\_t \doxylink{stream__buffer_8h_a6c882a1d9f26c40f93f271bd1b844b3b}{xStreamBufferReceiveFromISR( StreamBufferHandle\_t xStreamBuffer,                                     void *pvRxData,                                     size\_t xBufferLengthBytes,                                     BaseType\_t *pxHigherPriorityTaskWoken )};
\end{DoxyPre}
...
\doxylink{stream__buffer_8c_ac30372f81bb381115f91d7daa384db2d}{StreamBuffer\_t} xStreamBuffer;
...
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xHigherPriorityTaskWoken = pdFALSE;  // Initialised to pdFALSE.
    ...
    // \doxylink{stream__buffer_8h_a6c882a1d9f26c40f93f271bd1b844b3b}{xStreamBufferReceiveFromISR()} then a task that has a priority above the
