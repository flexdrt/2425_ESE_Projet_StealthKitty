...
\begin{DoxyPre}
\doxylink{croutine_8h_a26af3d36f22a04168eebdf5b08465d6e}{crQUEUE\_SEND(                  CoRoutineHandle\_t xHandle,                  QueueHandle\_t pxQueue,                  void *pvItemToQueue,                  TickType\_t xTicksToWait,                  BaseType\_t *pxResult             )}\end{DoxyPre}
...
static \doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xNumberToPost = 0;
static \doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xResult;

   // Co-\/routines must begin with a call to \doxylink{croutine_8h_a19a57a201a325e8af1207ed68c4aedde}{crSTART()}.
   \doxylink{croutine_8h_a19a57a201a325e8af1207ed68c4aedde}{crSTART( xHandle )};

   for( ;; )
   \{
       // This assumes the queue has already been created.
       \doxylink{croutine_8h_a26af3d36f22a04168eebdf5b08465d6e}{crQUEUE\_SEND( xHandle, xCoRoutineQueue, \&xNumberToPost, NO\_DELAY, \&xResult )};
       ...
       // Delay for 100 ticks.
       \doxylink{croutine_8h_a05a06feb11028f2d1d440ea335f562ba}{crDELAY( xHandle, 100 )};
   \}

   // Co-\/routines must end with a call to \doxylink{croutine_8h_ae6038cc976689b50000475ebfc4e2f23}{crEND()}.
   \doxylink{croutine_8h_ae6038cc976689b50000475ebfc4e2f23}{crEND()};
\}\end{DoxyPre}
