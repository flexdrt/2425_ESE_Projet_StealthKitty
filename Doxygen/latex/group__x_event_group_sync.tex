...
\begin{DoxyPre}
   \doxylink{event__groups_8h_ab2f21b93db0b2a0ab64d7a81ff32ac2e}{EventBits\_t} \doxylink{event__groups_8h_a869511456b86426f52e2eec898bff341}{xEventGroupSync( EventGroupHandle\_t xEventGroup,                                 const EventBits\_t uxBitsToSet,                                 const EventBits\_t uxBitsToWaitFor,                                 TickType\_t xTicksToWait )};
\end{DoxyPre}
...
\doxylink{event__groups_8h_acab96e0b6a5cab7f7b29822b79cc78ed}{EventGroupHandle\_t} xEventBits;

void vTask0( void *pvParameters )
\{
\doxylink{event__groups_8h_ab2f21b93db0b2a0ab64d7a81ff32ac2e}{EventBits\_t} uxReturn;
\doxylink{portmacro_8h_aa69c48c6e902ce54f70886e6573c92a9}{TickType\_t} xTicksToWait = 100 / portTICK\_PERIOD\_MS;
    ...
    \{
        ...
        // to \doxylink{event__groups_8h_a869511456b86426f52e2eec898bff341}{xEventGroupSync()} timed out.
    \}
   \}
\}
...
\{
    ...
    // \doxylink{event__groups_8h_a869511456b86426f52e2eec898bff341}{xEventGroupSync()} was called with an indefinite block time, so
