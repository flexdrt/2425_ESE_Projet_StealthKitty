...
semphr. h 
\begin{DoxyPre}\doxylink{semphr_8h_ad88c6df4a04beedeac782918c8a332f5}{SemaphoreHandle\_t} xSemaphoreCreateCounting( UBaseType\_t uxMaxCount, UBaseType\_t uxInitialCount )\end{DoxyPre}
