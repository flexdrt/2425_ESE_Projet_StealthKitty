...
croutine. h 
\begin{DoxyPre}
 \doxylink{croutine_8h_ac8eb0a81c5cf69de7e4edd73ce44a3be}{crQUEUE\_SEND\_FROM\_ISR(                            QueueHandle\_t pxQueue,                            void *pvItemToQueue,                            BaseType\_t xCoRoutinePreviouslyWoken                       )}\end{DoxyPre}
...
\{
char cRxedChar;
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xResult;

    // All co-\/routines must start with a call to \doxylink{croutine_8h_a19a57a201a325e8af1207ed68c4aedde}{crSTART()}.
    ...
    \{
        ...
        \doxylink{croutine_8h_a586d57fd9a3e2aa5ae66484ed3be36c9}{crQUEUE\_RECEIVE( xHandle, xCommsRxQueue, \&uxLEDToFlash, portMAX\_DELAY, \&xResult )};
    ...
    // All co-\/routines must end with a call to \doxylink{croutine_8h_ae6038cc976689b50000475ebfc4e2f23}{crEND()}.
...
\{
char cRxedChar;
\doxylink{portmacro_8h_a46fb21e00ae0729d7515c0fbf2269796}{BaseType\_t} xCRWokenByPost = pdFALSE;
    ...
    \{
        ...
        xCRWokenByPost = \doxylink{croutine_8h_ac8eb0a81c5cf69de7e4edd73ce44a3be}{crQUEUE\_SEND\_FROM\_ISR( xCommsRxQueue, \&cRxedChar, xCRWokenByPost )};
    \}
\}\end{DoxyPre}
